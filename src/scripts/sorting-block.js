...
if (selectCatalog) {
  inputSelect.addEventListener('click', function () {
    ...
    selectOptions.forEach(option => {
      if (
        option.textContent === inputSelect.querySelector('span').textContent
      ) {
  ...
  document.addEventListener('click', function (event) {
    const isClickInside =
      inputSelect.contains(event.target) || inputForm.contains(event.target);
...
const selectOptionsPagination = document.querySelectorAll(
  '.select-show_option',
);
...
if (inputSelectPagination || selectOptionsPagination) {
  inputSelectPagination.forEach(item => {
    item.addEventListener('click', function () {
      ...
      const selectOptionsPagination = this.querySelectorAll(
        '.select-show_option',
      );
      selectOptionsPagination.forEach(selectOption => {
        if (
          selectOption.textContent === this.querySelector('span').textContent
        ) {
  ...
  selectOptionsPagination.forEach(item => {
    item.addEventListener('click', function () {
      if (
        this.textContent !==
        this.closest('.navi-catalog_show').querySelector('span').textContent
      ) {
        this.closest('.navi-catalog_show').querySelector('span').textContent =
          this.textContent;
      }
  ...
  document.addEventListener('click', function (event) {
    inputSelectPagination.forEach(item => {
      const isClickInside =
        ...
        item.querySelector('.select-show_form').contains(event.target);
